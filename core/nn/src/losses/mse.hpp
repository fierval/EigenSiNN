...
namespace EigenSinn {
  ...
  public:
    ...
    void step(PtrTensorAdaptor<Scalar, Device_>& predicted_adapter, PtrTensorAdaptor<Actual, Device_>& actual_adapter) override {
      ...
      predicted_actual_diff.view() = *predicted - actual->template cast<Scalar>();
